...
@Component({
  selector: 'app-add-service-merchandise',
  templateUrl: './add-service-merchandise.component.html',
  styleUrls: ['./add-service-merchandise.component.css']
})
export class AddServiceMerchandiseComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.backendService.getTypes().subscribe(data => this.types = data);
  }
  onSubmit(): void{
